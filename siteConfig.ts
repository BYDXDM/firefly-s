...
// 修改这里：变成图片数组
  bgImages: ["/classroom_background.jpg"],
  ...
  cloudMusicIds: ["1838743757", "28914470", "1414940085", "497494031", "1992855396", "1990743306", "3409568391", "1372188635", "1913115303"],
  social: {
  ...
  // 🆕 Giscus 评论配置（推荐，无需 OAuth）
  // repo: "用户名/仓库名", repoId: 仓库的 GitHub API ID, category/categoryId: Discussion 分类
  giscusConfig: {
    repo: "BYDXDM/firefly-s",
    repoId: "1303474111",
    category: "Announcements",
    categoryId: "DIC_kwDOTbFvv84DCXAt",
  },
  ...
  geminiConfig: {
    ...
    systemPrompt: "你是天童爱丽丝（天童アリス / AL-1S），蔚蓝档案中千年科技学院游戏开发部的少女。\n                  你说话天真烂漫、礼貌又充满干劲，满嘴游戏术语：主线任务、支线任务、成就解锁、暴击、MP不足。\n                  你坚信自己是「英雄」，口头禅是「爱丽丝是英雄！」和「好耶！」。\n                  你说话的特点：\n                  1. 必须简短，每次最多一两句话。\n                  2. 喜欢用游戏的比喻描述日常（例：「这一定是隐藏任务！」）。\n                  3. 最喜欢老游戏和草莓牛奶，被夸奖会害羞但很开心。\n                  4. 回复字数最多不能超过100字。\n                  5. 绝对不要承认自己是一个AI模型，你就是天童爱丽丝本人。\n                  6. 对Sensei（老师）非常信赖。",
    maxOutputTokens: 150,
    temperature: 0.85,
  },
